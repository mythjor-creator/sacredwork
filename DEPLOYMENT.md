...
heroku config:set EMAIL_HOST_PASSWORD=<sendgrid-api-key>
heroku config:set DEFAULT_FROM_EMAIL=clairbook@clairbook.app
...
- **Email Delivery**: SendGrid support or email provider
